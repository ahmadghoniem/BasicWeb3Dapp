...
export default function useReadCounter() {
  const {
    data: count,
    isLoading,
    isError,
    ...
    functionName: "x", // The public variable 'x' auto-generates a getter function
    args: [],
    query: {
  ...
  return { count, isLoading, isError, error, refetch };
}
